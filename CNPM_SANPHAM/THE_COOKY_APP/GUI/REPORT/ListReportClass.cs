...
{
    public partial class ListReportClass : Form
    {
        ...
        private void LoadClassrooms()
        {
            ...
            foreach (var classroom in classrooms)
            {
                ...
                dgvListClassroom.Rows[rowIndex].Cells[5].Value = classroomBLL.GetClassroomByPicture(classroom.Picture).Count; // Số lượng thực tế
        ...
        private void ListReportClass_Load(object sender, EventArgs e)
        {
            CheckAndShowEmptyMessage();
        }
        ...
        private void dgvListClassroom_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                ReportClass reportClass = new ReportClass(selectedClassroom);
